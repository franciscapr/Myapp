...
class JobOffersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_offer" do
    assert_difference("JobOffer.count") do
      post job_offers_url, params: { job_offer: { description: @job_offer.description, title: @job_offer.title } }
    end
  ...
  test "should update job_offer" do
    patch job_offer_url(@job_offer), params: { job_offer: { description: @job_offer.description, title: @job_offer.title } }
