...
class PostulationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create postulation" do
    assert_difference("Postulation.count") do
      post postulations_url, params: { postulation: { job_offer_id: @postulation.job_offer_id, message: @postulation.message, user_id: @postulation.user_id } }
    end
  ...
  test "should update postulation" do
    patch postulation_url(@postulation), params: { postulation: { job_offer_id: @postulation.job_offer_id, message: @postulation.message, user_id: @postulation.user_id } }
